...
const _en = AppStrings(
  ...
  heroBio: '10+ years building high-performance mobile apps & websites as a Freelance Developer with Flutter, .NET Core & Spring Boot. Specialist in Fintech Security.',
  ...
  aboutBio1: "I'm Amit Kumar Tiwari — Freelance Mobile Architect & Full Stack Developer.",
  aboutBio2: 'With 10+ years of professional experience, I design and deliver end-to-end mobile apps and websites as a freelance architect: Flutter, .NET Core, Spring Boot and Native Android.',
  ...
  expAndroid: 'Native Android (Java/Kotlin)',  expSpringBoot: 'Spring Boot & .NET APIs',
  ...
  servicesSubtitle: 'Freelance Mobile · Backend · Full Stack — end-to-end delivery',
  svcFlutterTitle: 'Flutter Development',
  svcFlutterDesc: 'Beautiful, performant mobile apps and websites for iOS, Android & Web.',
  svcAndroidTitle: 'Native Android',
  svcAndroidDesc: 'Production-grade Android apps in Java & Kotlin with Jetpack.',
  svcSpringBootTitle: 'Backend — .NET & Spring Boot',
  svcSpringBootDesc: 'RESTful APIs, microservices and server-side logic with .NET Core and Java Spring Boot.',
  svcFullStackTitle: 'Full Stack Delivery',
  svcFullStackDesc: 'End-to-end ownership: mobile/web frontend + REST backend.',
  ...
  projHealthcareDesc: 'Teleconsultation & health records platform serving 500k+ patients. Flutter + .NET / Spring Boot, HL7 FHIR standards, end-to-end encrypted health data.',
  ...
  projSpringApiDesc: 'Production-ready .NET & Spring Boot template with JWT auth, role-based access, Hibernate ORM, and Docker.',
...
const _ar = AppStrings(
  ...
  heroBio: 'أكثر من 10 سنوات في بناء تطبيقات الجوال والمواقع كـ مطور مستقل باستخدام Flutter و.NET Core وSpring Boot. متخصص في أمان Fintech.',
  ...
  svcSpringBootTitle: 'الخلفية — .NET & Spring Boot',
...
const _fr = AppStrings(
  ...
  heroBio: 'Plus de 10 ans à créer des applications mobiles et sites web en tant que Freelance avec Flutter, .NET Core et Spring Boot. Spécialiste en sécurité Fintech.',
...
const _de = AppStrings(
  ...
  heroBio: 'Über 10 Jahre Entwicklung von mobilen Apps und Webseiten als Freelancer mit Flutter, .NET Core und Spring Boot. Spezialist für Fintech-Sicherheit.',
...
const _it = AppStrings(
  ...
  heroBio: 'Oltre 10 anni a creare app mobili e siti web come Freelance con Flutter, .NET Core e Spring Boot. Specialista in sicurezza Fintech.',
...
const _es = AppStrings(
  ...
  heroBio: 'Más de 10 años creando apps móviles y sitios web como Freelance con Flutter, .NET Core y Spring Boot. Especialista en seguridad Fintech.',
...
const _pt = AppStrings(
  ...
  heroBio: 'Mais de 10 anos criando apps móveis e sites como Freelance com Flutter, .NET Core e Spring Boot. Especialista em segurança Fintech.',
...
const _ru = AppStrings(
  ...
  heroBio: 'Более 10 лет создания мобильных приложений и сайтов как Фриланс-разработчик с Flutter, .NET Core и Spring Boot. Специалист по безопасности Fintech.',
  ...
  svcSpringBootTitle: 'Бэкенд — .NET & Spring Boot',
...
const _zh = AppStrings(
  ...
  heroRole: '全栈开发工程师',
  heroBio: '10余年作为自由职业开发者使用Flutter、.NET Core和Spring Boot构建移动应用和网站。专注于金融科技安全领域。',
  ...
  svcSpringBootTitle: '后端 — .NET & Spring Boot',
...
const _ja = AppStrings(
  ...
  heroRole: 'フルスタック開発者',
  heroBio: 'Flutter・.NET Core・Spring Bootを使用して、フリーランスとして10年以上モバイルアプリやWebサイトを構築。フィンテックセキュリティのスペシャリスト。',
  ...
  svcSpringBootTitle: 'バックエンド — .NET & Spring Boot',
...
const _ko = AppStrings(
  ...
  heroRole: '풀스택 개발자',
  heroBio: '프리랜서 개발자로서 Flutter, .NET Core, Spring Boot로 10년 이상 모바일 앱 및 웹사이트를 구축했습니다. 핀테크 보안 전문가.',
  ...
  svcSpringBootTitle: '백엔드 — .NET & Spring Boot',
...
const _hi = AppStrings(
  ...
  heroBio: 'फ्रीलांस डेवलपर के रूप में Flutter, .NET Core और Spring Boot के साथ 10+ वर्षों से मोबाइल ऐप और वेबसाइट निर्माण। Fintech सुरक्षा विशेषज्ञ।',
  ...
  aboutBio1: 'मैं Amit Kumar Tiwari हूँ — फ्रीलांस मोबाइल आर्किटेक्ट और फुल स्टैक डेवलपर।',
  aboutBio2: '10+ वर्षों के पेशेवर अनुभव के साथ, मैं फ्रीलांस आर्किटेक्ट के रूप में एंड-टू-एंड मोबाइल ऐप और वेबसाइट डिलीवर करता हूँ: Flutter, .NET Core और Spring Boot।',
  ...
  expAndroid: 'नेटिव Android (Java/Kotlin)',   expSpringBoot: '.NET और Spring Boot APIs',
  ...
  servicesSubtitle: 'फ्रीलांस मोबाइल · बैकएंड · फुल स्टैक — संपूर्ण डिलीवरी',
  svcFlutterTitle: 'Flutter विकास',
  svcFlutterDesc: 'iOS, Android और Web के लिए सुंदर, उच्च-प्रदर्शन मोबाइल ऐप और वेबसाइट।',
  svcAndroidTitle: 'नेटिव Android',
  svcAndroidDesc: 'Java & Kotlin और Jetpack के साथ प्रोडक्शन-ग्रेड Android ऐप्स।',
  svcSpringBootTitle: 'बैकएंड — .NET और Spring Boot',
  svcSpringBootDesc: '.NET Core और Java Spring Boot के साथ RESTful APIs, माइक्रोसर्विसेस और सर्वर लॉजिक।',
  svcFullStackTitle: 'फुल स्टैक डिलीवरी',
  svcFullStackDesc: 'संपूर्ण जिम्मेदारी: मोबाइल/वेब फ्रंटएंड + REST बैकएंड।',
  ...
  projHealthcareDesc: '5 लाख+ मरीजों के लिए टेलीकंसल्टेशन और स्वास्थ्य रिकॉर्ड प्लेटफॉर्म। Flutter + .NET / Spring Boot, HL7 FHIR मानक।',
  ...
  projSpringApiDesc: 'JWT ऑथ, रोल-बेस्ड एक्सेस, और .NET / Spring Boot के साथ प्रोडक्शन-रेडी टेम्पलेट।',
