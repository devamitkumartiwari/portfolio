          ...
          Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Utilty.openUrl(
                      "https://drive.google.com/file/d/13XU0eRJMfdAv_ai5LrfqsFQXCb6C3zYf/view?usp=sharing");
                },
                child: MouseRegion(
                    ...
                    .map((e) => Container(
                          ...
                          decoration: BoxDecoration(
                            color: ref.watch(themeProvider).isDarkMode
                                ? const Color.fromARGB(75, 33, 51, 32)
                                : Colors.grey[50],
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Icon(
                                designProcesses[index].iconData,
                                color: designProcesses[index].color,
                                size: 52,
                              ),
